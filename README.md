...
2. Copy them into `<vault>/.obsidian/plugins/samind-3d-graph/`
3. Reload Obsidian and enable "Samind 3D Graph" under Community Plugins

### 👨‍💻 Development

The plugin is written in TypeScript and uses [3d-force-graph](https://github.com/vasturiano/3d-force-graph) (three.js) for rendering. For more information, check the [dev docs](docs/dev-docs.md).
